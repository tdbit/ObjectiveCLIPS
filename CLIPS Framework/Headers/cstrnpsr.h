...
typedef struct constraintParseRecord CONSTRAINT_PARSE_RECORD;
   ...
   LOCALE CLIPS_BOOLEAN                        CheckConstraintParseConflicts(void *,CONSTRAINT_RECORD *);
   ...
   LOCALE CLIPS_BOOLEAN                        StandardConstraint(char *);
   LOCALE CLIPS_BOOLEAN                        ParseStandardConstraint(void *,char *,char *,
                                                                 CONSTRAINT_RECORD *,
