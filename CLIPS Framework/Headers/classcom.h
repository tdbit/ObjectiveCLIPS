...
LOCALE CLIPS_BOOLEAN DefclassInScope(void *,DEFCLASS *,struct defmodule *);
LOCALE void *EnvGetNextDefclass(void *,void *);
LOCALE CLIPS_BOOLEAN EnvIsDefclassDeletable(void *,void *);
...
LOCALE CLIPS_BOOLEAN EnvUndefclass(void *,void *);
LOCALE CLIPS_BOOLEAN HasSuperclass(DEFCLASS *,DEFCLASS *);
