...
#define SetFactListChanged(a) EnvSetFactListChanged(GetCurrentEnvironment(),a)
   ...
   LOCALE CLIPS_BOOLEAN                        EnvGetFactSlot(void *,void *,char *,DATA_OBJECT *);
   ...
   LOCALE CLIPS_BOOLEAN                        EnvRetract(void *,void *);
   ...
   LOCALE CLIPS_BOOLEAN                        EnvPutFactSlot(void *,void *,char *,DATA_OBJECT *);
   LOCALE CLIPS_BOOLEAN                        EnvAssignFactSlotDefaults(void *,void *);
   LOCALE CLIPS_BOOLEAN                        CopyFactSlotValues(void *,void *,void *);
