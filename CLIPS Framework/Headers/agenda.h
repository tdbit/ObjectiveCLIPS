...
struct agendaData
  { 
   ...
   int AgendaChanged;
#if DYNAMIC_SALIENCE
   CLIPS_BOOLEAN SalienceEvaluation;
#endif
#if CONFLICT_RESOLUTION_STRATEGIES
   int Strategy;
#endif
...
#define SetSalienceEvaluation(a) EnvSetSalienceEvaluation(GetCurrentEnvironment(),a)
   ...
   LOCALE CLIPS_BOOLEAN                 MoveActivationToTop(void *,void *);
   LOCALE CLIPS_BOOLEAN                 EnvDeleteActivation(void *,void *);
   LOCALE CLIPS_BOOLEAN                 DetachActivation(void *,void *);
   ...
   LOCALE CLIPS_BOOLEAN                 EnvGetSalienceEvaluation(void *);
   LOCALE CLIPS_BOOLEAN                 EnvSetSalienceEvaluation(void *,CLIPS_BOOLEAN);
   ...
   LOCALE CLIPS_BOOLEAN                 EnvRefresh(void *,void *);
#if DEBUGGING_FUNCTIONS
