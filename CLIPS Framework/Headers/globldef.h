...
#define SetGlobalsChanged(a) EnvSetGlobalsChanged(GetCurrentEnvironment(),a)
   ...
   LOCALE CLIPS_BOOLEAN                        EnvIsDefglobalDeletable(void *,void *);
   ...
   LOCALE CLIPS_BOOLEAN                        EnvGetDefglobalValue(void *,char *,DATA_OBJECT_PTR);
   LOCALE CLIPS_BOOLEAN                        EnvSetDefglobalValue(void *,char *,DATA_OBJECT_PTR);
