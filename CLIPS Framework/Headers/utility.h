...
#define RemovePeriodicFunction(a) EnvRemovePeriodicFunction(GetCurrentEnvironment(),a)
   ...
   LOCALE void                           PeriodicCleanup(void *,CLIPS_BOOLEAN,CLIPS_BOOLEAN);
   LOCALE CLIPS_BOOLEAN                        AddCleanupFunction(void *,char *,void (*)(void *),int);
   LOCALE CLIPS_BOOLEAN                        EnvAddPeriodicFunction(void *,char *,void (*)(void *),int);
   LOCALE CLIPS_BOOLEAN                        AddPeriodicFunction(char *,void (*)(void),int);
   LOCALE CLIPS_BOOLEAN                        RemoveCleanupFunction(void *,char *);
   LOCALE CLIPS_BOOLEAN                        EnvRemovePeriodicFunction(void *,char *);
   ...
   LOCALE struct callFunctionItem       *AddFunctionToCallList(void *,char *,int,void (*)(void *),
                                                               struct callFunctionItem *,CLIPS_BOOLEAN);
