...
LOCALE CLIPS_BOOLEAN ClassAbstractPCommand(void *);
#if DEFRULE_CONSTRUCT
LOCALE CLIPS_BOOLEAN ClassReactivePCommand(void *);
#endif
...
LOCALE CLIPS_BOOLEAN EnvClassAbstractP(void *,void *);
#if DEFRULE_CONSTRUCT
LOCALE CLIPS_BOOLEAN EnvClassReactiveP(void *,void *);
#endif
