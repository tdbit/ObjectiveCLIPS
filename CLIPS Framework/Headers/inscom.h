...
struct instanceData
  { 
   ...
   CLIPS_BOOLEAN ObjectModDupMsgValid;
  };
...
LOCALE CLIPS_BOOLEAN EnvDeleteInstance(void *,void *);
LOCALE CLIPS_BOOLEAN EnvUnmakeInstance(void *,void *);
...
LOCALE CLIPS_BOOLEAN DeleteInstanceCommand(void *);
LOCALE CLIPS_BOOLEAN UnmakeInstanceCommand(void *);
...
LOCALE CLIPS_BOOLEAN InstanceAddressPCommand(void *);
LOCALE CLIPS_BOOLEAN InstanceNamePCommand(void *);
LOCALE CLIPS_BOOLEAN InstancePCommand(void *);
LOCALE CLIPS_BOOLEAN InstanceExistPCommand(void *);
LOCALE CLIPS_BOOLEAN CreateInstanceHandler(void *);
