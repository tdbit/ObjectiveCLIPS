...
struct constraintData
  { 
   ...
   CLIPS_BOOLEAN StaticConstraintChecking;
   CLIPS_BOOLEAN DynamicConstraintChecking;
...
#define SetStaticConstraintChecking(a) EnvSetStaticConstraintChecking(GetCurrentEnvironment(),a)
   ...
   LOCALE CLIPS_BOOLEAN                        EnvSetDynamicConstraintChecking(void *,int);
   LOCALE CLIPS_BOOLEAN                        EnvGetDynamicConstraintChecking(void *);
   LOCALE CLIPS_BOOLEAN                        EnvSetStaticConstraintChecking(void *,int);
   LOCALE CLIPS_BOOLEAN                        EnvGetStaticConstraintChecking(void *);
