...
struct entityRecord
  {
   ...
   CLIPS_BOOLEAN (*deleteFunction)(void *,void *);
   CLIPS_BOOLEAN (*evaluateFunction)(void *,void *,DATA_OBJECT *);
...
#define FunctionCall(a,b,c) EnvFunctionCall(GetCurrentEnvironment(),a,b,c)
   ...
   LOCALE void                           SetEvaluationError(void *,CLIPS_BOOLEAN);
   ...
   LOCALE CLIPS_BOOLEAN                        GetFunctionReference(void *,char *,FUNCTION_REFERENCE *);
   LOCALE CLIPS_BOOLEAN                        DOsEqual(DATA_OBJECT_PTR,DATA_OBJECT_PTR);
