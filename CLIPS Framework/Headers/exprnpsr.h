...
#define SetSequenceOperatorRecognition(a) EnvSetSequenceOperatorRecognition(GetCurrentEnvironment(),a)
   ...
   LOCALE CLIPS_BOOLEAN                        ReplaceSequenceExpansionOps(void *,struct expr *,struct expr *,
                                                                     void *,void *);
   ...
   LOCALE CLIPS_BOOLEAN                        EnvSetSequenceOperatorRecognition(void *,int);
   LOCALE CLIPS_BOOLEAN                        EnvGetSequenceOperatorRecognition(void *);
