...
/*********************************************************/
globle CLIPS_BOOLEAN EnvRetract(
  void *theEnv,
  void *vTheFact)
  {
   struct fact *theFact = (struct fact *) vTheFact;
...
/******************************************/
globle CLIPS_BOOLEAN EnvGetFactSlot(
  void *theEnv,
  void *vTheFact,
  char *slotName,
...
/***************************************/
globle CLIPS_BOOLEAN EnvPutFactSlot(
  void *theEnv,
  void *vTheFact,
  char *slotName,
  DATA_OBJECT *theValue)
...
/*   not yet been set.                                  */
/********************************************************/
globle CLIPS_BOOLEAN EnvAssignFactSlotDefaults(
  void *theEnv,
  void *vTheFact)
  {
   struct fact *theFact = (struct fact *) vTheFact;
...
/***************************************************************/
globle CLIPS_BOOLEAN CopyFactSlotValues(
  void *theEnv,
  void *vTheDestFact,
  void *vTheSourceFact)
  {
