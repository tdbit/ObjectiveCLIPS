...
/********************************************/
globle CLIPS_BOOLEAN MoveActivationToTop(
  void *theEnv,
  void *vtheActivation)
  {
...
/**********************************************/
globle CLIPS_BOOLEAN EnvDeleteActivation(
  void *theEnv,
  void *theActivation)
  {
...
/*******************************************************/
globle CLIPS_BOOLEAN DetachActivation(
  void *theEnv,
  void *vTheActivation)
  {
   struct defruleModule *theModuleItem;
...
/************************************************************/
globle CLIPS_BOOLEAN EnvRefresh(
  void *theEnv,
  void *theRule)
  {
...
/*  or every cycle).                                            */
/****************************************************************/
globle CLIPS_BOOLEAN EnvGetSalienceEvaluation(
  void *theEnv)
  {   
...
/***********************************************/
globle CLIPS_BOOLEAN EnvSetSalienceEvaluation(
  void *theEnv,
  int value)
  {
   int ov;
