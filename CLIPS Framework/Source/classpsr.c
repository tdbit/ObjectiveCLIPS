...
static CLIPS_BOOLEAN ValidClassName(void *,char *,DEFCLASS **);
static CLIPS_BOOLEAN ParseSimpleQualifier(void *,char *,char *,char *,char *,CLIPS_BOOLEAN *,CLIPS_BOOLEAN *);
static CLIPS_BOOLEAN ReadUntilClosingParen(void *,char *,struct token *);
...
/***********************************************************
  ...
  NOTES        : GetConstructNameAndComment() (called before
                 ...
                 another module
 ***********************************************************/
static CLIPS_BOOLEAN ValidClassName(
  void *theEnv,
  char *theClassName,
...
/***************************************************************
  ...
  NOTES        : None
 ***************************************************************/
static CLIPS_BOOLEAN ParseSimpleQualifier(
  void *theEnv,
  char *readSource,
  char *classQualifier,
  char *clearRelation,
  char *setRelation,
  CLIPS_BOOLEAN *alreadyTestedFlag,
  CLIPS_BOOLEAN *binaryFlag)
  {
 ...
 ***************************************************/
static CLIPS_BOOLEAN ReadUntilClosingParen(
  void *theEnv,
  char *readSource,
