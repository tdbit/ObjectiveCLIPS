...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 GetVariableDefinition(void *,char *,int *,int,struct token *);
...
/*********************************************************************/
globle CLIPS_BOOLEAN ParseDefglobal(
  void *theEnv,
  char *readSource)
  {
...
/***************************************************************/
static CLIPS_BOOLEAN GetVariableDefinition(
  void *theEnv,
  char *readSource,
  int *defglobalError,
  int tokenRead,
...
/*****************************************************************/
globle CLIPS_BOOLEAN ReplaceGlobalVariable(
  void *theEnv,
  struct expr *ePtr)
  {
