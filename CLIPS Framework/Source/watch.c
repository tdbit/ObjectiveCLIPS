...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 RecognizeWatchRouters(void *,char *);
...
/*************************************************************/
globle CLIPS_BOOLEAN AddWatchItem(
  void *theEnv,
  char *name,
  int code,
  unsigned *flag,
...
#pragma argsused
#endif
static CLIPS_BOOLEAN RecognizeWatchRouters(
  void *theEnv,
  char *logName)
  {
