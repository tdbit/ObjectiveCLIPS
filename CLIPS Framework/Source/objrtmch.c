...
static CLIPS_BOOLEAN CompareSlotBitMaps(SLOT_BITMAP *,SLOT_BITMAP *);
...
static CLIPS_BOOLEAN EvaluateObjectPatternTest(void *,int,struct multifieldMarker *,EXPRESSION *,
                                         OBJECT_PATTERN_NODE *);
...
/***************************************************
  ...
  NOTES        : When the delay is set to FALSE,
                 ...
                 are performed
 ***************************************************/
globle CLIPS_BOOLEAN SetDelayObjectPatternMatching(
  void *theEnv,
  int value)
  {
   CLIPS_BOOLEAN oldval;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN GetDelayObjectPatternMatching(
  void *theEnv)
  {
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN CompareSlotBitMaps(
  SLOT_BITMAP *smap1,
  SLOT_BITMAP *smap2)
  {
 ...
 ******************************************************/
static CLIPS_BOOLEAN EvaluateObjectPatternTest(
  void *theEnv,
  int objectSlotField,
