...
static CLIPS_BOOLEAN PatternParserFind(SYMBOL_HN *);
static struct lhsParseNode *ObjectLHSParse(void *,char *,struct token *);
static CLIPS_BOOLEAN ReorderAndAnalyzeObjectPattern(void *,struct lhsParseNode *);
...
static CLIPS_BOOLEAN CheckDuplicateSlots(void *,struct lhsParseNode *,SYMBOL_HN *);
...
static CLIPS_BOOLEAN EmptyClassBitMap(CLASS_BITMAP *);
static CLIPS_BOOLEAN IdenticalClassBitMap(CLASS_BITMAP *,CLASS_BITMAP *);
static CLIPS_BOOLEAN ProcessClassRestriction(void *,CLASS_BITMAP *,struct lhsParseNode **,int);
 ...
 *****************************************************/
static CLIPS_BOOLEAN PatternParserFind(
  SYMBOL_HN *value)
  {
...
/**************************************************************
  ...
  NOTES        : Adds a default is-a slot if one does not
                 already exist
 **************************************************************/
static CLIPS_BOOLEAN ReorderAndAnalyzeObjectPattern(
  void *theEnv,
...
/******************************************************
  ...
  NOTES        : None
 ******************************************************/
static CLIPS_BOOLEAN CheckDuplicateSlots(
  void *theEnv,
...
/****************************************************
  ...
  NOTES        : None
 ****************************************************/
static CLIPS_BOOLEAN EmptyClassBitMap(
  CLASS_BITMAP *bmp)
  {
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN IdenticalClassBitMap(
  CLASS_BITMAP *cs1,
  CLASS_BITMAP *cs2)
  {
   register int i;
...
/*****************************************************************
  ...
  NOTES        : None
 *****************************************************************/
static CLIPS_BOOLEAN ProcessClassRestriction(
  void *theEnv,
  CLASS_BITMAP *clsset,
