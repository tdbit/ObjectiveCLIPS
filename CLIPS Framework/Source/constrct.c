...
/*******************************************************/
globle CLIPS_BOOLEAN RemoveSaveFunction(
  void *theEnv,
  char *name)
  {
   int found;
...
/*   value of PrintWhileLoading.     */
/*************************************/
globle CLIPS_BOOLEAN GetPrintWhileLoading(
  void *theEnv)
  {
...
/*************************************/
globle CLIPS_BOOLEAN AddResetFunction(
  char *name,
...
/*   to ListOfResetFunctions.           */
/****************************************/
globle CLIPS_BOOLEAN EnvAddResetFunction(
  void *theEnv,
  char *name,
  void (*functionPtr)(void *),
  int priority)
...
/**********************************************/
globle CLIPS_BOOLEAN EnvRemoveResetFunction(
  void *theEnv,
  char *name)
  {
   int found;
...
/*   the determination).                                 */
/*********************************************************/
globle CLIPS_BOOLEAN ClearReady(
  void *theEnv)
  {
   struct callFunctionItem *theFunction;
   int (*tempFunction)(void *);
...
/******************************************/
globle CLIPS_BOOLEAN AddClearReadyFunction(
  void *theEnv,
  char *name,
...
/************************************************/
globle CLIPS_BOOLEAN RemoveClearReadyFunction(
  void *theEnv,
  char *name)
  {
   int found;
...
/*************************************/
globle CLIPS_BOOLEAN AddClearFunction(
  char *name,
  void (*functionPtr)(void),
  int priority)
  {
...
/*   to ListOfClearFunctions.           */
/****************************************/
globle CLIPS_BOOLEAN EnvAddClearFunction(
  void *theEnv,
  char *name,
  void (*functionPtr)(void *),
  int priority)
...
/**********************************************/
globle CLIPS_BOOLEAN EnvRemoveClearFunction(
  void *theEnv,
  char *name)
  {
   int found;
...
/************************************/
globle CLIPS_BOOLEAN AddSaveFunction(
  void *theEnv,
  char *name,
