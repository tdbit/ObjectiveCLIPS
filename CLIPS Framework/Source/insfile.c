...
static long InstancesSaveCommandParser(void *,char *,long (*)(void *,char *,int,
                                                   EXPRESSION *,CLIPS_BOOLEAN));
static DATA_OBJECT *ProcessSaveClassList(void *,char *,EXPRESSION *,int,CLIPS_BOOLEAN);
static void ReturnSaveClassList(void *,DATA_OBJECT *);
static long SaveOrMarkInstances(void *,void *,int,DATA_OBJECT *,CLIPS_BOOLEAN,CLIPS_BOOLEAN,
                                         void (*)(void *,void *,INSTANCE_TYPE *));
static long SaveOrMarkInstancesOfClass(void *,void *,struct defmodule *,int,DEFCLASS *,
                                                CLIPS_BOOLEAN,int,void (*)(void *,void *,INSTANCE_TYPE *));
...
#if BLOAD_INSTANCES
static CLIPS_BOOLEAN VerifyBinaryHeader(void *,char *);
static CLIPS_BOOLEAN LoadSingleBinaryInstance(void *);
...
static long InstancesSaveCommandParser(
  void *theEnv,
  char *functionName,
  long (*saveFunction)(void *,char *,int,EXPRESSION *,CLIPS_BOOLEAN))
  {
   char *fileFound;
   DATA_OBJECT temp;
   int argCount,saveCode = LOCAL_SAVE;
   EXPRESSION *classList = NULL;
   CLIPS_BOOLEAN inheritFlag = FALSE;
...
/*******************************************************
  ...
  NOTES        : Assumes file already open with 
                 GenOpenReadBinary
 *******************************************************/
static CLIPS_BOOLEAN VerifyBinaryHeader(
  void *theEnv,
  char *theFile)
  {
   char buf[20];
 ...
 ***************************************************/
static CLIPS_BOOLEAN LoadSingleBinaryInstance(
  void *theEnv)
  {
