...
/*   for the eq function.           */
/************************************/
globle CLIPS_BOOLEAN EqFunction(
  void *theEnv)
  {
...
/*************************************/
globle CLIPS_BOOLEAN NeqFunction(
  void *theEnv)
  {
   DATA_OBJECT item, nextItem;
   int numArgs, i;
...
/*****************************************/
globle CLIPS_BOOLEAN StringpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/*****************************************/
globle CLIPS_BOOLEAN SymbolpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/*****************************************/
globle CLIPS_BOOLEAN LexemepFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/*****************************************/
globle CLIPS_BOOLEAN NumberpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/****************************************/
globle CLIPS_BOOLEAN FloatpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/******************************************/
globle CLIPS_BOOLEAN IntegerpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/*********************************************/
globle CLIPS_BOOLEAN MultifieldpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/******************************************/
globle CLIPS_BOOLEAN PointerpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
...
/*************************************/
globle CLIPS_BOOLEAN NotFunction(
  void *theEnv)
  {
...
/*************************************/
globle CLIPS_BOOLEAN AndFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT result;
...
/*   for the or function.           */
/************************************/
globle CLIPS_BOOLEAN OrFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT result;
...
/*****************************************/
globle CLIPS_BOOLEAN LessThanOrEqualFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/*   routine for the >= function.           */
/********************************************/
globle CLIPS_BOOLEAN GreaterThanOrEqualFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/*   routine for the < function.  */
/**********************************/
globle CLIPS_BOOLEAN LessThanFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/*   routine for the > function.     */
/*************************************/
globle CLIPS_BOOLEAN GreaterThanFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/*   routine for the = function.      */
/**************************************/
globle CLIPS_BOOLEAN NumericEqualFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/*   routine for the <> function.        */
/*****************************************/
globle CLIPS_BOOLEAN NumericNotEqualFunction(
  void *theEnv)
  {
   EXPRESSION *theArgument;
   DATA_OBJECT rv1, rv2;
...
/**************************************/
globle CLIPS_BOOLEAN OddpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
   long num, halfnum;
...
/***************************************/
globle CLIPS_BOOLEAN EvenpFunction(
  void *theEnv)
  {
   DATA_OBJECT item;
   long num, halfnum;
