...
/************************************************************/
globle CLIPS_BOOLEAN ConstantExpression(
  struct expr *testPtr)
  {
   while (testPtr != NULL)
     {
...
/*   is a constant, otherwise FALSE.      */
/************************************************/
globle CLIPS_BOOLEAN ConstantType(
  int theType)
  {
   switch (theType)
     {
...
/*****************************************************************************/
globle CLIPS_BOOLEAN IdenticalExpression(
...
/************************************************************/
globle CLIPS_BOOLEAN ExpressionContainsVariables(
  struct expr *theExpression,
  CLIPS_BOOLEAN globalsAreVariables)
  {
