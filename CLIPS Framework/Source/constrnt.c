...
/******************************************************/
globle CLIPS_BOOLEAN EnvSetDynamicConstraintChecking(
  void *theEnv,
  int value)
  {
   int ov;
...
/******************************************************/
globle CLIPS_BOOLEAN EnvGetDynamicConstraintChecking(
  void *theEnv)
  { 
...
/*****************************************************/
globle CLIPS_BOOLEAN EnvSetStaticConstraintChecking(
  void *theEnv,
  int value)
  {
   int ov;
...
/*****************************************************/
globle CLIPS_BOOLEAN EnvGetStaticConstraintChecking(
  void *theEnv)
  {    
