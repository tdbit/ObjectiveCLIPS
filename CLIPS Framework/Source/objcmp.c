...
static void SingleDefclassToCode(void *,FILE *,int,int,DEFCLASS *,int,
                                 ...
                                 int,int,int,int,int,int);
static CLIPS_BOOLEAN InheritanceLinksToCode(void *,FILE **,char *,int,int,FILE *,
                                      int *,int,DEFCLASS *,int *,
                                      int *,int *,struct CodeGeneratorFile *);
static CLIPS_BOOLEAN SlotsToCode(void *,FILE **,char *,int,int,FILE *,
                           int *,int,DEFCLASS *,int *,
                           int *,int *,struct CodeGeneratorFile *);
static CLIPS_BOOLEAN TemplateSlotsToCode(void *,FILE **,char *,int,int,FILE *,
                                   int *,int,DEFCLASS *,int *,
                                   int *,int *,struct CodeGeneratorFile *);
static CLIPS_BOOLEAN OrderedSlotsToCode(void *,FILE **,char *,int,int,FILE *,
                                  int *,int,DEFCLASS *,int *,
                                  int *,int *,struct CodeGeneratorFile *);
static CLIPS_BOOLEAN HandlersToCode(void *,FILE **,char *,int,int,FILE *,
                              int *,int,DEFCLASS *,int *,
                              int *,int *,struct CodeGeneratorFile *);
static CLIPS_BOOLEAN OrderedHandlersToCode(void *,FILE **,char *,int,int,FILE *,
                                     int *,int,DEFCLASS *,int *,
                                     int *,int *,struct CodeGeneratorFile *);
...
/***********************************************************
  ...
  NOTES        : None
 ***********************************************************/
static CLIPS_BOOLEAN InheritanceLinksToCode(
  void *theEnv,
  FILE **classLinkFile,
  char *fileName,
  int fileID,
...
/***********************************************************
  ...
  NOTES        : None
 ***********************************************************/
static CLIPS_BOOLEAN SlotsToCode(
  void *theEnv,
  FILE **slotFile,
  char *fileName,
  int fileID,
...
/*************************************************************
  ...
  NOTES        : None
 *************************************************************/
static CLIPS_BOOLEAN TemplateSlotsToCode(
  void *theEnv,
...
/*************************************************************
  ...
  NOTES        : None
 *************************************************************/
static CLIPS_BOOLEAN OrderedSlotsToCode(
  void *theEnv,
...
/*************************************************************
  ...
  NOTES        : None
 *************************************************************/
static CLIPS_BOOLEAN HandlersToCode(
  void *theEnv,
  FILE **handlerFile,
  char *fileName,
  int fileID,
...
/****************************************************************
  ...
  NOTES        : None
 ****************************************************************/
static CLIPS_BOOLEAN OrderedHandlersToCode(
  void *theEnv,
