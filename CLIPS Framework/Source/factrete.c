...
/***************************************************************/
globle CLIPS_BOOLEAN FactPNGetVar1(
  void *theEnv,
  void *theValue,
...
/**************************************************/
globle CLIPS_BOOLEAN FactPNGetVar2(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
/*****************************************************************/
globle CLIPS_BOOLEAN FactPNGetVar3(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN FactPNConstant1(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN FactPNConstant2(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
/**************************************************************/
globle CLIPS_BOOLEAN FactJNGetVar1(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
/*   slot that contains at most one multifield variable.        */
/****************************************************************/
globle CLIPS_BOOLEAN FactJNGetVar3(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
...
/****************************************************/
globle CLIPS_BOOLEAN FactSlotLength(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR returnValue)
  {
