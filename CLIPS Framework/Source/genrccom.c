...
static CLIPS_BOOLEAN EvaluateGenericCall(void *,void *,DATA_OBJECT *);
...
/**************************************************************
  ...
  NOTES        : None
 **************************************************************/
globle CLIPS_BOOLEAN EnvUndefgeneric(
  void *theEnv,
  void *vptr)
  {
#if (MAC_MCW || IBM_MCW) && (RUN_TIME || BLOAD_ONLY)
...
/**************************************************************
  ...
  NOTES        : None
 **************************************************************/
globle CLIPS_BOOLEAN EnvUndefmethod(
  void *theEnv,
  void *vptr,
  unsigned mi)
  {
...
/*******************************************************
  ...
  NOTES        : None
 *******************************************************/
static CLIPS_BOOLEAN EvaluateGenericCall(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
