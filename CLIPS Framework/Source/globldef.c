...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 GetDefglobalValue2(void *,void *,DATA_OBJECT_PTR);
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN EnvIsDefglobalDeletable(
  void *theEnv,
  void *ptr)
  {
#if MAC_MCW || IBM_MCW || MAC_XCD
...
/**********************************************************/
static CLIPS_BOOLEAN GetDefglobalValue2(
  void *theEnv,
  void *theValue,
  DATA_OBJECT_PTR vPtr)
  {
...
/*   global variable in the supplied DATA_OBJECT.           */
/************************************************************/
globle CLIPS_BOOLEAN EnvGetDefglobalValue(
  void *theEnv,
  char *variableName,
  DATA_OBJECT_PTR vPtr)
  {
...
/****************************************************************/
globle CLIPS_BOOLEAN EnvSetDefglobalValue(
  void *theEnv,
  char *variableName,
  DATA_OBJECT_PTR vPtr)
  {
