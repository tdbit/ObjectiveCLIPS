...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 CheckRangeAgainstCardinalityConstraint(void *,int,int,CONSTRAINT_RECORD *);
   static int                     CheckFunctionReturnType(int,CONSTRAINT_RECORD *);
   static CLIPS_BOOLEAN                 CheckTypeConstraint(int,CONSTRAINT_RECORD *);
   static CLIPS_BOOLEAN                 CheckRangeConstraint(void *,int,void *,CONSTRAINT_RECORD *);
...
/****************************************************/
static CLIPS_BOOLEAN CheckTypeConstraint(
  int type,
  CONSTRAINT_RECORD *constraints)
  {
...
/********************************************************/
globle CLIPS_BOOLEAN CheckCardinalityConstraint(
  void *theEnv,
  long number,
  CONSTRAINT_RECORD *constraints)
  {
...
/*****************************************************************/
static CLIPS_BOOLEAN CheckRangeAgainstCardinalityConstraint(
  void *theEnv,
  int min,
  int max,
  CONSTRAINT_RECORD *constraints)
...
/*   FALSE is returned.                                               */
/**********************************************************************/
globle CLIPS_BOOLEAN CheckAllowedValuesConstraint(
  int type,
  void *vPtr,
  CONSTRAINT_RECORD *constraints)
  {
...
/*************************************************************/
static CLIPS_BOOLEAN CheckRangeConstraint(
  void *theEnv,
  int type,
  void *vPtr,
  CONSTRAINT_RECORD *constraints)
...
/*****************************************************/
globle CLIPS_BOOLEAN UnmatchableConstraint(
  CONSTRAINT_RECORD *theConstraint)
  {
