 ...
 **********************************************************************/
globle CLIPS_BOOLEAN ReplaceSequenceExpansionOps(
  void *theEnv,
  EXPRESSION *actions,
  EXPRESSION *fcallexp,
  void *expcall,
...
/********************************************************/
globle CLIPS_BOOLEAN EnvSetSequenceOperatorRecognition(
  void *theEnv,
  int value)
  {
   int ov;
...
/********************************************************/
globle CLIPS_BOOLEAN EnvGetSequenceOperatorRecognition(
  void *theEnv)
  {
