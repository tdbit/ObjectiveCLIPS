...
static CLIPS_BOOLEAN RemoveAllDefinstances(void *);
...
static CLIPS_BOOLEAN ClearDefinstancesReady(void *);
...
/***********************************************************
  ...
  NOTES        : None
 ***********************************************************/
globle CLIPS_BOOLEAN EnvUndefinstances(
  void *theEnv,
  void *vptr)
  {
...
static SYMBOL_HN *ParseDefinstancesName(
   ...
   *active = FALSE;
   dname = GetConstructNameAndComment(theEnv,readSource,&DefclassData(theEnv)->ObjectParseToken,"definstances",
                                      ...
                                      TRUE,FALSE,DEFMODULE_CONSTRUCT);
   if (dname == NULL)
     return(NULL);
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN RemoveAllDefinstances(
  void *theEnv)
  {
 ...
 ***************************************************/
static CLIPS_BOOLEAN ClearDefinstancesReady(
  void *theEnv)
  {
   int flagBuffer = TRUE;
