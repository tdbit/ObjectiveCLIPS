...
static CLIPS_BOOLEAN RtnProcParam(void *,void *,DATA_OBJECT *);
static CLIPS_BOOLEAN GetProcBind(void *,void *,DATA_OBJECT *);
static CLIPS_BOOLEAN PutProcBind(void *,void *,DATA_OBJECT *);
static CLIPS_BOOLEAN RtnProcWild(void *,void *,DATA_OBJECT *);
...
static CLIPS_BOOLEAN EvaluateBadCall(void *,void *,DATA_OBJECT *);
#endif
      ...
      if (actions->argList != NULL)
        {
         ...
         if ((actions->value == (void *) FindFunction(theEnv,"bind")) &&
             (actions->argList->type == SYMBOL))
           {
            ...
            actions->value = AddBitMap(theEnv,(void *) &boundPosn,(int) sizeof(CLIPS_BOOLEAN));
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN RtnProcParam(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
...
/**************************************************************
  ...
  NOTES        : None
 **************************************************************/
static CLIPS_BOOLEAN GetProcBind(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
...
/**************************************************************
  ...
  NOTES        : None
 **************************************************************/
static CLIPS_BOOLEAN PutProcBind(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
...
/****************************************************************
  ...
  NOTES        : Multi-field is NOT on list of ephemeral segments
 ****************************************************************/
static CLIPS_BOOLEAN RtnProcWild(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
 ...
 ******************************************************/
static CLIPS_BOOLEAN EvaluateBadCall(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
