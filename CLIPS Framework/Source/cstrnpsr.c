...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 ParseRangeCardinalityAttribute(void *,
                                                                 char *,CONSTRAINT_RECORD *,
                                                                 CONSTRAINT_PARSE_RECORD *,
                                                                 char *,int);
   static CLIPS_BOOLEAN                 ParseTypeAttribute(void *,char *,CONSTRAINT_RECORD *);
   static void                    AddToRestrictionList(void *,int,CONSTRAINT_RECORD *,
                                                       CONSTRAINT_RECORD *);
   static CLIPS_BOOLEAN                 ParseAllowedValuesAttribute(void *,char *,char *,
                                                              CONSTRAINT_RECORD *,
                                                              CONSTRAINT_PARSE_RECORD *);
...
/********************************************************************/
globle CLIPS_BOOLEAN CheckConstraintParseConflicts(
  void *theEnv,
...
/************************************************************************/
globle CLIPS_BOOLEAN StandardConstraint(
  char *constraintName)
  {
...
/***********************************************************************/
globle CLIPS_BOOLEAN ParseStandardConstraint(
  void *theEnv,
  char *readSource,
  char *constraintName,
  CONSTRAINT_RECORD *constraints,
...
/*******************************************************************/
static CLIPS_BOOLEAN ParseAllowedValuesAttribute(
  void *theEnv,
  char *readSource,
  char *constraintName,
  CONSTRAINT_RECORD *constraints,
...
/**************************************************/
static CLIPS_BOOLEAN ParseTypeAttribute(
  void *theEnv,
  char *readSource,
  CONSTRAINT_RECORD *constraints)
  {
...
/***************************************************************************/
static CLIPS_BOOLEAN ParseRangeCardinalityAttribute(
  void *theEnv,
  char *readSource,
  CONSTRAINT_RECORD *constraints,
  CONSTRAINT_PARSE_RECORD *parsedConstraints,
