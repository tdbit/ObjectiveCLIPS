...
static CLIPS_BOOLEAN EvaluateDeffunctionCall(void *,void *,DATA_OBJECT *);
...
static CLIPS_BOOLEAN ClearDeffunctionsReady(void *);
#endif

#if (! BLOAD_ONLY) && (! RUN_TIME)
static CLIPS_BOOLEAN RemoveAllDeffunctions(void *);
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvUndeffunction(
  void *theEnv,
  void *vptr)
  {
...
/*******************************************************
  ...
  NOTES        : None
 *******************************************************/
static CLIPS_BOOLEAN EvaluateDeffunctionCall(
  void *theEnv,
  void *value,
  DATA_OBJECT *result)
  {
 ...
 ***************************************************/
static CLIPS_BOOLEAN ClearDeffunctionsReady(
  void *theEnv)
  {
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN RemoveAllDeffunctions(
  void *theEnv)
  {
   DEFFUNCTION *dptr,*dtmp;
   unsigned oldbusy;
   CLIPS_BOOLEAN success = TRUE;
