...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 MVRangeCheck(long,long,long *,int);
#if (! BLOAD_ONLY) && (! RUN_TIME)
...
globle CLIPS_BOOLEAN SubsetpFunction(
  void *theEnv)
  {
...
/***************************************/
/* 6.05 Bug Fix */
CLIPS_BOOLEAN FindDOsInSegment(
...
/* MVRangeCheck:  */
/******************************************************/
static CLIPS_BOOLEAN MVRangeCheck(
  long si,
  long ei,
  long *elist,
  int epaircnt)
