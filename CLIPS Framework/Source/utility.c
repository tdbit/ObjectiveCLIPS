...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 AddCPFunction(void *,char *,void (*)(void *),
                                                int,struct cleanupFunction **,CLIPS_BOOLEAN);
   static CLIPS_BOOLEAN                 RemoveCPFunction(void *,char *,struct cleanupFunction **);
...
globle void PeriodicCleanup(
  void *theEnv,
  CLIPS_BOOLEAN cleanupAllDepths,
  CLIPS_BOOLEAN useHeuristics)
  {
   int oldDepth = -1;
...
/***************************************************/
globle CLIPS_BOOLEAN AddCleanupFunction(
  void *theEnv,
  char *name,
...
/****************************************************/
globle CLIPS_BOOLEAN AddPeriodicFunction(
  char *name,
  void (*theFunction)(void),
  int priority)
  {
...
/*   of functions called to handle periodic tasks.     */
/*******************************************************/
globle CLIPS_BOOLEAN EnvAddPeriodicFunction(
  void *theEnv,
  char *name,
  void (*theFunction)(void *),
  int priority)
...
/**********************************/
static CLIPS_BOOLEAN AddCPFunction(
  void *theEnv,
  char *name,
  void (*theFunction)(void *),
  int priority,
  struct cleanupFunction **head,
  CLIPS_BOOLEAN environmentAware)
  {
...
/*   as returning free memory to the memory pool.      */
/*******************************************************/
globle CLIPS_BOOLEAN RemoveCleanupFunction(
  void *theEnv,
  char *name)
  {
...
/**********************************************************/
globle CLIPS_BOOLEAN EnvRemovePeriodicFunction(
  void *theEnv,
  char *name)
  {
...
/****************************************/
static CLIPS_BOOLEAN RemoveCPFunction(
  void *theEnv,
  char *name,
  struct cleanupFunction **head)
  {
