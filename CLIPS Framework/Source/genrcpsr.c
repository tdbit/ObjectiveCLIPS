...
static CLIPS_BOOLEAN ValidGenericName(void *,char *);
...
static CLIPS_BOOLEAN RedundantClasses(void *,void *,void *);
 ...
 ***************************************************************************/
globle CLIPS_BOOLEAN ParseDefgeneric(
  void *theEnv,
  char *readSource)
  {
   SYMBOL_HN *gname;
...
/***************************************************************************
  ...
  NOTES        : H/L Syntax :
                 ...
                 <wildcard>    :== $?<name> |
                                   ($?<name> <type>* [<restriction-query>])
 ***************************************************************************/
globle CLIPS_BOOLEAN ParseDefmethod(
  void *theEnv,
  char *readSource)
  {
   SYMBOL_HN *gname;
...
/***********************************************************
  ...
  NOTES        : GetConstructNameAndComment() (called before
                 ...
                 another module
 ***********************************************************/
static CLIPS_BOOLEAN ValidGenericName(
  void *theEnv,
...
/*************************************************************
  ...
  NOTES        : None
 *************************************************************/
static CLIPS_BOOLEAN RedundantClasses(
  void *theEnv,
  void *c1,
  void *c2)
  {
