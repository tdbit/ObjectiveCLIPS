...
static CLIPS_BOOLEAN ParseDefaultFacet(void *,char *,char *,SLOT_DESC *);
static void BuildCompositeFacets(void *,SLOT_DESC *,PACKED_CLASS_LINKS *,char *,
                                 CONSTRAINT_PARSE_RECORD *);
static CLIPS_BOOLEAN CheckForFacetConflicts(void *,SLOT_DESC *,CONSTRAINT_PARSE_RECORD *);
static CLIPS_BOOLEAN EvaluateSlotDefaultValue(void *,SLOT_DESC *,char *);
 ...
 *************************************************************/
static CLIPS_BOOLEAN ParseDefaultFacet(
  void *theEnv,
  char *readSource,
  char *specbits,
  SLOT_DESC *slot)
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN CheckForFacetConflicts(
  void *theEnv,
  SLOT_DESC *sd,
  CONSTRAINT_PARSE_RECORD *parsedConstraint)
  {
 ...
 ********************************************************************/
static CLIPS_BOOLEAN EvaluateSlotDefaultValue(
  void *theEnv,
  SLOT_DESC *sd,
  char *specbits)
  {
