...
static long ListInstancesInModule(void *,int,char *,char *,CLIPS_BOOLEAN,CLIPS_BOOLEAN);
static long TabulateInstances(void *,int,char *,DEFCLASS *,CLIPS_BOOLEAN,CLIPS_BOOLEAN);
#endif
 ...
 *******************************************************************/
globle CLIPS_BOOLEAN EnvDeleteInstance(
  void *theEnv,
  void *iptr)
  {
...
/*******************************************************************
  ...
  NOTES        : C interface for deleting instances
 *******************************************************************/
globle CLIPS_BOOLEAN EnvUnmakeInstance(
  void *theEnv,
  void *iptr)
  {
   INSTANCE_TYPE *ins;
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN CreateInstanceHandler(
  void *theEnv)
  {
#if MAC_MCW || IBM_MCW || MAC_XCD
#pragma unused(theEnv)
 ...
 ******************************************************/
globle CLIPS_BOOLEAN DeleteInstanceCommand(
  void *theEnv)
  {
 ...
 ********************************************************************/
globle CLIPS_BOOLEAN UnmakeInstanceCommand(
  void *theEnv)
  {
 ...
 **************************************************************/
globle CLIPS_BOOLEAN InstanceAddressPCommand(
  void *theEnv)
  {
   DATA_OBJECT temp;
 ...
 **************************************************************/
globle CLIPS_BOOLEAN InstanceNamePCommand(
  void *theEnv)
  {
   DATA_OBJECT temp;
 ...
 *****************************************************************/
globle CLIPS_BOOLEAN InstancePCommand(
  void *theEnv)
  {
   DATA_OBJECT temp;
 ...
 ********************************************************/
globle CLIPS_BOOLEAN InstanceExistPCommand(
  void *theEnv)
  {
   DATA_OBJECT temp;
