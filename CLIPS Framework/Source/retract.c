...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 FindNextConflictingAlphaMatch(void *,struct partialMatch *,
                                                                struct partialMatch *,
                                                                struct joinNode *);
   static CLIPS_BOOLEAN                 PartialMatchDefunct(void *,struct partialMatch *);
...
/*   satisfied.                                               */
/**************************************************************/
static CLIPS_BOOLEAN FindNextConflictingAlphaMatch(
  void *theEnv,
...
/*   FALSE.                                                */
/***********************************************************/
static CLIPS_BOOLEAN PartialMatchDefunct(
  void *theEnv,
