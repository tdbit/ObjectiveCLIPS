...
/****************************************************/
globle CLIPS_BOOLEAN DeleteNamedConstruct(
  void *theEnv,
  char *constructName,
...
/*************************************/
globle CLIPS_BOOLEAN Undefconstruct(
  void *theEnv,
  void *theConstruct,
  struct construct *constructClass)
  {
...
globle void *LookupConstruct(
  ...
  struct construct *constructClass,
  char *constructName,
  CLIPS_BOOLEAN moduleNameAllowed)
  {
   void *theConstruct;
   char *constructType;
   int moduleCount;
