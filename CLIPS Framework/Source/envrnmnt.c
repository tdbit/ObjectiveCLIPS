...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 RemoveHashedEnvironment(struct environmentData *);
...
/*******************************************************/
globle CLIPS_BOOLEAN AllocateEnvironmentData(
...
/***************************************************************/
globle CLIPS_BOOLEAN DeallocateEnvironmentData()
  {
#if ALLOW_ENVIRONMENT_GLOBALS
...
/***************************************************/
static CLIPS_BOOLEAN RemoveHashedEnvironment(
  struct environmentData *theEnvironment)
  {
   unsigned long hashValue;
...
/*   environment index.                           */
/**************************************************/
globle CLIPS_BOOLEAN SetCurrentEnvironmentByIndex(
  unsigned long environmentIndex)
  {
   struct environmentData *theEnvironment;
...
/**************************************************/
globle CLIPS_BOOLEAN AddEnvironmentCleanupFunction(
  void *vtheEnv,
  char *name,
