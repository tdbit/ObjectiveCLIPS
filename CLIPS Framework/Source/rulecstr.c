...
/***************************************/
   ...
   static CLIPS_BOOLEAN                 CheckForUnmatchableConstraints(void *,struct lhsParseNode *,int);
   static CLIPS_BOOLEAN                 MultifieldCardinalityViolation(void *,struct lhsParseNode *);
   ...
   static CLIPS_BOOLEAN                 CheckArgumentForConstraintError(void *,struct expr *,struct expr*,
...
/***********************************************************/
static CLIPS_BOOLEAN CheckForUnmatchableConstraints(
  void *theEnv,
...
/***************************************************************/
static CLIPS_BOOLEAN MultifieldCardinalityViolation(
  void *theEnv,
  struct lhsParseNode *theNode)
  {
...
/*   violations.                                   */
/***************************************************/
globle CLIPS_BOOLEAN ProcessConnectedConstraints(
  void *theEnv,
  struct lhsParseNode *theNode,
...
/*******************************************/
globle CLIPS_BOOLEAN CheckRHSForConstraintErrors(
  void *theEnv,
...
/*************************************************************/
static CLIPS_BOOLEAN CheckArgumentForConstraintError(
  void *theEnv,
  struct expr *expressionList,
  struct expr *lastOne,
  int i,
