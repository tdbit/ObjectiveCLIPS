...
static SLOT_DESC *CheckSlotExists(void *,char *,DEFCLASS **,CLIPS_BOOLEAN,CLIPS_BOOLEAN);
static SLOT_DESC *LookupSlot(void *,DEFCLASS *,char *,CLIPS_BOOLEAN);
...
static CLIPS_BOOLEAN PrintSlotSources(void *,char *,SYMBOL_HN *,PACKED_CLASS_LINKS *,unsigned,int);
 ...
 *********************************************************************/
globle CLIPS_BOOLEAN SuperclassPCommand(
  void *theEnv)
  {
   DEFCLASS *c1,*c2;
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN EnvSuperclassP(
  void *theEnv,
  void *firstClass,
  void *secondClass)
  {
 ...
 *********************************************************************/
globle CLIPS_BOOLEAN SubclassPCommand(
  void *theEnv)
  {
   DEFCLASS *c1,*c2;
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN EnvSubclassP(
  void *theEnv,
  void *firstClass,
  void *secondClass)
  {
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvSlotExistP(
  void *theEnv,
  void *theDefclass,
  char *slotName,
  CLIPS_BOOLEAN inheritFlag)
  {
 ...
 **********************************************************************/
globle CLIPS_BOOLEAN SlotWritablePCommand(
  void *theEnv)
  {
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvSlotWritableP(
  void *theEnv,
  void *theDefclass,
  char *slotName)
  {
 ...
 **********************************************************************/
globle CLIPS_BOOLEAN SlotInitablePCommand(
  void *theEnv)
  {
   DEFCLASS *theDefclass;
   SLOT_DESC *sd;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvSlotInitableP(
  void *theEnv,
  void *theDefclass,
  char *slotName)
  {
 ...
 **********************************************************************/
globle CLIPS_BOOLEAN SlotPublicPCommand(
  void *theEnv)
  {
   DEFCLASS *theDefclass;
   SLOT_DESC *sd;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvSlotPublicP(
  void *theEnv,
  void *theDefclass,
  char *slotName)
  {
 ...
 **********************************************************************/
globle CLIPS_BOOLEAN SlotDirectAccessPCommand(
  void *theEnv)
  {
   DEFCLASS *theDefclass;
   SLOT_DESC *sd;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle CLIPS_BOOLEAN EnvSlotDirectAccessP(
  void *theEnv,
  void *theDefclass,
  char *slotName)
  {
...
/*********************************************************
  ...
  NOTES        : None
 *********************************************************/
globle CLIPS_BOOLEAN SlotDefaultValue(
  void *theEnv,
  void *theDefclass,
  char *slotName,
  DATA_OBJECT_PTR theValue)
 ...
 ********************************************************/
globle CLIPS_BOOLEAN ClassExistPCommand(
  void *theEnv)
  {
   DATA_OBJECT temp;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static CLIPS_BOOLEAN PrintSlotSources(
  void *theEnv,
  char *logicalName,
  SYMBOL_HN *sname,
