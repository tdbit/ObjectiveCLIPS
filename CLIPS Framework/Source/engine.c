...
/***********************************/
globle CLIPS_BOOLEAN AddRunFunction(
  char *name,
...
/*   to the ListOfRunFunctions.       */
/**************************************/
globle CLIPS_BOOLEAN EnvAddRunFunction(
  void *theEnv,
  char *name,
  void (*functionPtr)(void *),
  int priority)
...
/********************************************/
globle CLIPS_BOOLEAN EnvRemoveRunFunction(
  void *theEnv,
  char *name)
  {
   int found;
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN EnvRemoveBreak(
  void *theEnv,
  void *theRule)
  {
#if MAC_MCW || IBM_MCW || MAC_XCD
...
#pragma argsused
#endif
globle CLIPS_BOOLEAN EnvDefruleHasBreakpoint(
  void *theEnv,
  void *theRule)
  {
#if MAC_MCW || IBM_MCW || MAC_XCD
